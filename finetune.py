...
def finetune():
    ...
    arguments = "--output_dir=output --overwrite_output_dir --model_type={} --model_name_or_path={} --do_train --train_data_file={} --per_device_train_batch_size=1 --num_train_epochs=3 --fp16 --gradient_accumulation_steps 1024".format(MODEL_TYPE, MODEL_PATH, TRAIN_FILE)

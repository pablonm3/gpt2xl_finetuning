...
def finetune():
    ...
    additional_args = ["--output_dir="+FILE_PATH+"/output", "--overwrite_output_dir", "--model_type="+MODEL_TYPE, "--model_name_or_path="+MODEL_PATH, "--do_train", "--train_data_file="+TRAIN_FILE, "--per_device_train_batch_size=1", "--num_train_epochs=3", "--fp16"]
